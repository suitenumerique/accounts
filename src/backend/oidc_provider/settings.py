...
class OIDCProviderSettings:
    ...
    def _get_oidc_rsa_private_key(self) -> str:
        ...
        if self._OAUTH2_PROVIDER_OIDC_RSA_PRIVATE_KEY:
            return self._OAUTH2_PROVIDER_OIDC_RSA_PRIVATE_KEY
