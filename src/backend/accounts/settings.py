    ...
    * DB_USER
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": values.Value(
                "accounts", environ_name="DB_NAME", environ_prefix=None
            ),
    ...
    LANGUAGE_COOKIE_NAME = "accounts_language"
    ...
    SPECTACULAR_SETTINGS = {
        "TITLE": "Accounts API",
        "DESCRIPTION": "This is the accounts API schema.",
        "VERSION": "1.0.0",
...
class Development(Base):
    ...
    CSRF_TRUSTED_ORIGINS = ["http://localhost:9901", "http://localhost:9900"]
    DEBUG = True
