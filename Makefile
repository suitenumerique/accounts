...
run-frontend-development: ## Run the frontend in development mode
	...
	cd $(PATH_FRONT_ACCOUNTS) && yarn dev
.PHONY: run-frontend-development

frontend-test: ## Run the frontend tests
	cd $(PATH_FRONT_ACCOUNTS) && yarn test
.PHONY: frontend-test
...
bump-packages-version: ## bump the version of the project - VERSION_TYPE can be "major", "minor", "patch"
	...
	cd ./src/frontend/apps/accounts/ && yarn version --no-git-tag-version --$(VERSION_TYPE)
