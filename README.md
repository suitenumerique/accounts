...
|-----------------|---------------------------------------------------------|--------------------------|-------------------------------|
| **Frontend**    | [http://localhost:9900](http://localhost:9900)          | Main Messages frontend   | None yet                      |
| **Backend API** | [http://localhost:9901](http://localhost:9901)          | Django                   | `admin@example.com` / `admin` |
